namespace AdventOfCode.Apps
{
    ...
    public class A_FactoryQuestionApp : IApp<string[], long>
    {
        ...
        public ISolver<string[], long> solver => new A_FactoryQuestionSolver();
        ...
        public A_FactoryQuestionApp(IInputReader reader, IOutputWriter writer)
        {
