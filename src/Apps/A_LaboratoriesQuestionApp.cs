namespace AdventOfCode.Apps
{
    ...
    public class A_LaboratoriesQuestionApp : IApp<char[,], long>
    {
        ...
        public ISolver<char[,], long> solver => new A_LaboratoriesQuestionSolver();
        ...
        public A_LaboratoriesQuestionApp(IInputReader reader, IOutputWriter writer)
        {
