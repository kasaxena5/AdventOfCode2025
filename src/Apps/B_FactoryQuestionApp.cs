namespace AdventOfCode.Apps
{
    ...
    public class B_FactoryQuestionApp : IApp<string[], long>
    {
        ...
        public ISolver<string[], long> solver => new B_FactoryQuestionSolver();
        ...
        public B_FactoryQuestionApp(IInputReader reader, IOutputWriter writer)
        {
