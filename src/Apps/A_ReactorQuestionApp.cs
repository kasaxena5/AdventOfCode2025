namespace AdventOfCode.Apps
{
    ...
    public class A_ReactorQuestionApp : IApp<string[], long>
    {
        ...
        public ISolver<string[], long> solver => new A_ReactorQuestionSolver();
        ...
        public A_ReactorQuestionApp(IInputReader reader, IOutputWriter writer)
        {
